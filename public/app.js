...
(function () {
  var _getInvoiceData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var invoiceData, invoiceObject, _i, _Object$entries, _Object$entries$_i, key, value, items, discountAmount, allProductTotal, i, _key, itemPrice, itemQty, priceAfterDiscount, productTotal;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          invoiceObject = {}; //transform data from API to local object
          for (_i = 0, _Object$entries = Object.entries(invoiceData); _i < _Object$entries.length; _i++) {
          ...
          for (i = 0; i < items.length; i++) {
            for (_key in items[i]) {
              ...
              itemQty = parseFloat(items[i].quantity).toFixed(2);
              priceAfterDiscount = itemPrice - (parseFloat(discountAmount) * -1).toFixed(2);
